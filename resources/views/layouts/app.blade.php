...
<body>
    ...
    <div id="sidebar">
        ...
        <nav class="mt-2">
            ...
            <a href="/konsumen" class="nav-link {{ request()->is('konsumen*') ? 'active' : '' }}">
            ...
            <a href="/pemesanan-supplier" class="nav-link {{ request()->is('pemesanan-supplier*') ? 'active' : '' }}">
                <i class="bi bi-cart-plus"></i> Pesan ke Supplier
            </a>
            <a href="/pemesanan-konsumen" class="nav-link {{ request()->is('pemesanan-konsumen*') ? 'active' : '' }}">
            ...
            <a href="/hutangs" class="nav-link {{ request()->is('hutangs*') ? 'active' : '' }}">
                <i class="bi bi-arrow-down-circle"></i> Hutang
            </a>
            <a href="/piutangs" class="nav-link {{ request()->is('piutangs*') ? 'active' : '' }}">
                <i class="bi bi-arrow-up-circle"></i> Piutang
            </a>

            <div class="nav-section">Retur</div>

            <a href="/retur-pembelian" class="nav-link {{ request()->is('retur-pembelian*') ? 'active' : '' }}">
                <i class="bi bi-arrow-return-left"></i> Retur Pembelian
            </a>
            <a href="/retur-penjualan" class="nav-link {{ request()->is('retur-penjualan*') ? 'active' : '' }}">
