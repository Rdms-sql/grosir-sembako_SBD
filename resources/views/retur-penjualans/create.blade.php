...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 text-primary"><i class="bi bi-plus-circle"></i> Tambah Retur Penjualan</h5>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('retur-penjualan.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-5">
                    <label class="form-label fw-bold">Penjualan <span class="text-danger">*</span></label>
                    <select name="id_penjualan" class="form-select" id="selectPenjualan" required>
                        <option value="">-- Pilih Penjualan --</option>
                        @foreach($penjualans as $p)
                            <option value="{{ $p->id_penjualan }}">
                                #{{ $p->id_penjualan }} — {{ $p->konsumen->nama_konsumen }}
            ...
            <div class="card border mb-4">
                <div class="card-header fw-bold">
                    ...
                    <small class="text-muted fw-normal">— Pilih penjualan dulu</small>
                </div>
                        ...
                        <tbody id="bodyBarang">
                            <tr>
                                <td colspan="5" class="text-center text-muted py-3">
                                    Pilih penjualan untuk memuat detail barang
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
...
<script>
document.getElementById('selectPenjualan').addEventListener('change', function() {
    var id = this.value;
    if (!id) {
        document.getElementById('bodyBarang').innerHTML =
            '<tr><td colspan="5" class="text-center text-muted py-3">Pilih penjualan untuk memuat detail barang</td></tr>';
        document.getElementById('totalLabel').textContent = 'Rp 0';
        return;
    }

    fetch('/retur-penjualan/detail/' + id)
        ...
        .then(function(details) {
            ...
            details.forEach(function(d, i) {
                ...
                tr.innerHTML =
                    ...
                    + '<td>' + d.jumlah_jual + '</td>'
                    + '<td><input type="number" name="barang[' + i + '][jumlah_retur]" class="form-control form-control-sm jumlah-retur" min="1" max="' + d.jumlah_jual + '" value="1" data-harga="' + d.harga_satuan + '" required></td>'
