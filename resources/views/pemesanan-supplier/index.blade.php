...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">📋 Pemesanan Supplier</h4>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('pemesanan-supplier.show', $p->id_pesan_supplier) }}"
                               class="btn btn-sm btn-info text-white">Detail</a>
                            @if($p->status === 'diajukan')
                                <a href="{{ route('pemesanan-supplier.edit', $p->id_pesan_supplier) }}"
                                   class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('pemesanan-supplier.destroy', $p->id_pesan_supplier) }}"
